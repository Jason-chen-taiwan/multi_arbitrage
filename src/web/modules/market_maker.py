...
獨立的做市商監控和策略模組，可以動態載入到 Dashboard
"""
...
def get_html() -> str:
    ...
    return """
    <!-- StandX BTC 做市商模組 -->
    <div class="section" id="marketMakerSection">
        <h2>📊 StandX BTC-USD 做市商</h2>
        <p style="color: #9ca3af; margin-bottom: 15px;">實時訂單簿深度與做市策略監控</p>
...
const MarketMaker = {
    ...
    init: function() {
        console.log('MarketMaker.init() called');
        this.loadOrderbook();
    ...
    loadOrderbook: async function() {
        try {
            ...
            console.log('MarketMaker: Failed to load orderbook:', error);
        }
    },
